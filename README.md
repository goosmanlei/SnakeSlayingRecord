...
三篇扩写的当前干净正文可单独阅读：[九女有名](imports/direction-01-clean.md)、[山心水](imports/direction-02-clean.md)、[把灯带回家](imports/direction-03-clean.md)。它们已导入正式审阅台，均为七场连续故事和 25 分钟制作估算；用户已于 2026-09-22 确认本轮文字优化完成，但尚未选定最终方向。用户允许通过删除旧资料替换，因此旧《山心水》的一条评论及旧修订不再在当前实例中；历史内容仍可从 Git 记录追溯。
