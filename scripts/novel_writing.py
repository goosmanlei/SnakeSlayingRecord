"""Project-local novel checkpoints; standard library only, no formal data writes."""
...
def canonical(value):
    # Keep the original serialization: existing checkpoint hashes must not change.
...
def main():
    ...
    try:
        result = run_cli(args.instance.resolve(), args)
